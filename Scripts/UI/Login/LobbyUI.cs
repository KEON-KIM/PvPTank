...
namespace PvpTank
{
    public partial class LobbyUI : MonoBehaviour
    {
       ...
       /* public GameObject recordObject;
        ...
        public TextMeshProUGUI[] recordContent = new TextMeshProUGUI[7];*/
        ...
        */
        ...
        void Update()
        {
            if (modelObject.activeSelf)
                modelObject.transform.Rotate(0, 2.5f, 0);
        }
            ...
            /* if (fadeObject != null)
             {
                 ...
                 {
                     Debug.Log("GAME LOADSCENE READY");
                     GameManager.GetInstance().ChangeState(GameManager.GameState.Ready);
                 });
             }
             else
        ...
        /*public void GetGameRecord()
        {
            ...
            MatchManager.GetInstance().GetMyMatchRecord(index, (MatchRecord record, bool isSuccess) =>
            {
        ...
        public void ReconnectInGameProcess()
        {
            ...
            MatchManager.GetInstance().ProcessReconnect();
        }
