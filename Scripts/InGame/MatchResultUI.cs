...
namespace PvpTank
{
    public class MatchResultUI : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            returnLobbyObject = backGroundObject.transform.GetChild(3).gameObject; // Fatch
        ...
        public void SetGameResult(MatchGameResult matchGameResult)
        {
            ...
            if(matchInstance.nowModeType == MatchModeType.Melee)
            {
                Debug.Log("MELEE GAME");
                var data = meleeResultObject.GetComponentsInChildren<TextMeshProUGUI>();
                if (data == null)
                {
